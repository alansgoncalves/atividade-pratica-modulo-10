...
const ListarTarefa = () => {
  ...
  const handleDeletar = () => {
    setTarefas(current =>
      current.filter(tarefa => tarefa.idTarefa !== idToDelete),
    );
    setOpenDialog(false);
  };
  ...
  return (
    <>
              ...
              <TableBody>
                {tarefas.map((row, indice) => (
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <Button variant="contained" color="error" onClick={() => handleDialogOpen(row.idTarefa)}><DeleteIcon fontSize="small" /></Button>
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
      ...
      <DialogBox open={openDialog} handleClose={handleDialogClose} handleDelete={handleDeletar} />
      <div>
        <Modal
          open={open}
          onClose={handleClose}
